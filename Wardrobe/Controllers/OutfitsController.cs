...
namespace Wardrobe.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        {
            var outfit = db.Outfit.Include(o => o.Accessories).Include(o => o.Bottoms).Include(o => o.Shoes).Include(o => o.Tops);
            return View(outfit.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Outfit outfit = db.Outfit.Find(id);
            if (outfit == null)
            {
                return HttpNotFound();
            }
